...
public class Library extends AppCompatActivity {
    ...
    public void OpenLibraryMap(View view){
        Intent intent = new Intent(this,ShowMap.class);
        intent.putExtra("apicall","api/location/getlibrarycoords");
        intent.putExtra("map",getString(R.string.library));
    ...
    private class RetrieveLocations extends AsyncTask<Integer, Void, String> {
        ...
        protected String doInBackground(Integer... position) {
            try {
                URL url = new URL(DBInteraction.api_url + "api/location/getlibrarylocations");
        ...
        protected void onPostExecute(String response) {
            LinearLayout layout = (LinearLayout) findViewById(R.id.librarylayout);
