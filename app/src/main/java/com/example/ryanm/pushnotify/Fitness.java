...
public class Fitness extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.fitness));
    ...
    private class RetrieveLocations extends AsyncTask<Integer, Void, String> {
        ...
        protected String doInBackground(Integer... position) {
            try {
                URL url = new URL(DBInteraction.api_url + "api/location/getfitnesslocations");
        ...
        protected void onPostExecute(String response) {
            LinearLayout layout = (LinearLayout) findViewById(R.id.fitnesslayout);
