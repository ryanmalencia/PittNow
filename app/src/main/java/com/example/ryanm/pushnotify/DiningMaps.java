...
import com.example.ryanm.pushnotify.DataTypes.DiningLocationCollection;
...
public class DiningMaps extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dining_maps);
    ...
    class RetrieveLocations extends AsyncTask<Integer, Void, String> {
        ...
        protected String doInBackground(Integer... position){
            try {
                URL url = new URL(DBInteraction.api_url + "api/location/getdiningcoords");
        ...
        protected void onPostExecute(String response) {
            if(response != null) {
                ...
                DiningLocationCollection locations;
                locations = gson.fromJson(response, DiningLocationCollection.class);
